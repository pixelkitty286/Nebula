...
/datum/ability_handler/psionics/do_grabbed_invocation(mob/user, atom/target)
	INVOKE_PSI_POWERS(user, get_grab_powers(SSpsi.faculties_by_intent[user.get_intent()]), target)
...
/datum/ability_handler/psionics/do_melee_invocation(mob/user, atom/target)
	INVOKE_PSI_POWERS(user, get_melee_powers(SSpsi.faculties_by_intent[user.get_intent()]), target)
...
/datum/ability_handler/psionics/do_ranged_invocation(mob/user, atom/target)
	INVOKE_PSI_POWERS(user, get_ranged_powers(SSpsi.faculties_by_intent[user.get_intent()]), target)
