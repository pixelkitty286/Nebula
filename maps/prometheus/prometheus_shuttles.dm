...
/datum/shuttle/autodock/overmap/research
	name = "Research Pod"
	shuttle_area = /area/ship/prometheus_pod_research
	dock_target = "research_shuttle"
	current_location = "nav_prometheus_research_pod_dock"
/area/ship/prometheus_pod_research
	name = "Research Pod"
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_ION_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT
/obj/effect/overmap/visitable/ship/landable/pod/research
	name = "prometheus Research Pod"
	shuttle = "Research Pod"
/obj/effect/shuttle_landmark/research_pod_dock
	name = "Research Docking Port"
	landmark_tag = "nav_prometheus_research_pod_dock"
...
/datum/shuttle/autodock/overmap/mining
	name = "Mining Pod"
	shuttle_area = /area/ship/prometheus_pod_mining
	dock_target = "mining_shuttle"
	current_location = "nav_prometheus_mining_pod_dock"
/area/ship/prometheus_pod_mining
	name = "Mining Pod"
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_ION_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT
/obj/effect/overmap/visitable/ship/landable/pod/mining
	name = "Prometheus Mining Pod"
	shuttle = "Mining Pod"
/obj/effect/shuttle_landmark/mining_pod_dock
	name = "Mining Docking Port"
	landmark_tag = "nav_prometheus_mining_pod_dock"
...
/datum/shuttle/autodock/overmap/engineering
	...
	shuttle_area = /area/ship/prometheus_pod_engineering
	dock_target = "engineering_shuttle"
	current_location = "nav_prometheus_engineering_pod_dock"
/area/ship/prometheus_pod_engineering
	name = "Engineering Pod"
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_ION_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT
/obj/effect/overmap/visitable/ship/landable/pod/engineering
	name = "prometheus Engineering Pod"
	shuttle = "Engineering Pod"
/obj/effect/shuttle_landmark/engineering_pod_dock
	name = "Engineering Docking Port"
	landmark_tag = "nav_prometheus_engineering_pod_dock"
