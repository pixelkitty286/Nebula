/datum/map/prometheus
	name          = "Prometheus"
	full_name     = "NSB Prometheus"
	path          = "prometheus"

	station_name  = "NSB Prometheus"
	station_short = "Prometheus"
	...
	lobby_screens = list(
		'maps/prometheus/lobby/ill_1.png'
	)
...
/datum/map/prometheus/get_map_info()
	return "Welcome to NSB Prometheus, one of the largest remaining stopovers between the core worlds and the rim. Enjoy your stay!"
